...
public class GcstoFirestore extends DoFn<String, String> {
	...
	public void processElement(ProcessContext c) throws Exception {
		...
		Firestore firestore = FirestoreOptions.getDefaultInstance().toBuilder().setProjectId(pro_id)
		...
		jsonLines.add(data); // append the input to the list
		// batch_processing
	...
	private void processChunk(List<String> jsonLines, CollectionReference collection, Gson gson)
